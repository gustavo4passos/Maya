...
Level::Level() {
	_collisionRects.push_back(new Rect(-200.f, 200.f, 1000, 670));
	_collisionRects.push_back(new Rect(200.f, 139.f, 150.f, 10.f));
	_collisionRects.push_back(new Rect( 50.f, 79.f, 100.f, 10.f));
	_collisionRects.push_back(new Rect(0.f, 180.f, 70.f, 20.f));
	_collisionRects.push_back(new Rect(450.f, 50.f, 200.f, 150.f));
}
