...
INCLUDE_PATHS = $(SDL_INCLUDE_PATH) $(GLEW_INCLUDE_PATH) $(TINYXML2_INCLUDE_PATH) $(LUA_INCLUDE_PATH) $(TINYXML_INCLUDE_PATH) $(GLM_INCLUDE_PATH) $(IMGUI_INCLUDE_PATH)
endif
ifeq ($(OS), Linux)
endif
...
LIB_PATHS = $(SDL_LIB_PATH) $(LUA_LIB_PATH) $(GLEW_LIB_PATH) $(TINYXML2_LIB_PATH) $(TINYXML_LIB_PATH) $(IMGUI_LIB_PATH)
endif
ifeq ($(OS), LINUX)
endif
