...
INCLUDE_PATHS = $(SDL_INCLUDE_PATH) $(GLEW_INCLUDE_PATH) $(TINYXML2_INCLUDE_PATH) $(LUA_INCLUDE_PATH) $(TINYXML_INCLUDE_PATH) $(SDL_MIXER_INCLUDE_PATH) $(SDL_INCLUDE_DIRECT_PATH)
endif
ifeq ($(OS), Linux)
endif
...
LIB_PATHS = $(SDL_LIB_PATH) $(LUA_LIB_PATH) $(GLEW_LIB_PATH) $(TINYXML2_LIB_PATH) $(TINYXML_LIB_PATH) $(SDL_MIXER_LIB_PATH)
endif
ifeq ($(OS), LINUX)
endif

LINKER_FLAGS = -lmingw32 -lSDL2main -lSDL2 -lSDL2_Mixer -lOpenGL32 -lglew32 -lglu32 -llua53 -ltinyxml2 -ltinyxml
ifeq ($(OS), Windows_NT)
COMPILER_FLAGS = -Wall
endif
ifeq ($(OS), Linux)
